...
<?php 
  ...
  $employeen = mysqli_query($db,"select * from employee_tiers  ORDER BY tier_name");
        ...
        <div class="vali-form-group">
          <div class="col-md-4 control-label">
            ...
            <div class="col-md-4 control-label">
              ...
              <input type="text" name="mname" title="Middle Name" value="<?php echo(isset($editemp["MiddleName"]))?$editemp["MiddleName"]:""; ?>" class="form-control" placeholder="Middel Name" required="">
              </div>
            </div>
            ...
            <div class="vali-form-group">
            <div class="col-md-3 control-label">
              <label class="control-label">Employee Tier*</label>
              <div class="input-group">             
                  <span class="input-group-addon">
              <i class="fa fa-language" aria-hidden="true"></i>
              </span>
              <select name="employee" title="Employee" style="text-transform: capitalize;" required="">
                <option value="">-- Select Tier --</option>
                <?php while($rw = mysqli_fetch_assoc($employeen)){ ?> 
                  <option value="<?php echo $rw["TierId"]; ?>" <?php if(isset($editemp["TierId"]) && $editemp["TierId"]==$rw["TierId"]){ echo "Selected"; }?>> <?php echo $rw["tier_name"]; ?> </option>
                <?php } ?>
              </select>
              </div>
            </div>
