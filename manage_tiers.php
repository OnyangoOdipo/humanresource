...
if (isset($_POST['add_tier'])) {
    ...
    $query = "INSERT INTO employee_tiers (tier_name, basic_salary) VALUES ('$tier_name', '$basic_salary')";
...
if (isset($_POST['update_tier'])) {
    ...
    $query = "UPDATE employee_tiers SET tier_name='$tier_name', basic_salary='$basic_salary' WHERE id='$tier_id'";
    mysqli_query($db, $query);
}

$tiers = mysqli_query($db, "SELECT * FROM employee_tiers");
...
<head>
    <meta charset="UTF-8">
    <title>Manage Employee Tiers</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <h1>Manage Employee Tiers</h1>
    <form method="post">
        ...
        <button type="submit" name="add_tier">Add Tier</button>
    </form>
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php echo $tier['basic_salary']; ?></td>
            <td>
                <a href="edit_tier.php?id=<?php echo $tier['id']; ?>">Edit</a>
            </td>
        </tr>
        <?php } ?>
    </table>
