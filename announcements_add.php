...
<?php 
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    mysqli_query($db, "INSERT INTO announcements (title, content) VALUES ('$title', '$content')");
    header("Location: announcements.php?msg=Announcement Added");
  }
?>
<ol class="breadcrumb" style="margin: 10px 0px !important;">
  <li class="breadcrumb-item"><a href="Home.php">Home</a><i class="fa fa-angle-right"></i>New Announcement</li>
</ol>

<div class="validation-system" style="margin-top: 0;">
  <div class="validation-form">
    <h2>Add New Announcement</h2>
    <form method="POST" action="announcements_add.php">
